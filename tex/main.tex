...
\usepackage{titling}
\title{2021 Taiwan Online Programming Contest}
...
{
	\fancyhf{}
	\fancyhead[C]{\includegraphics[width=1\textwidth]{image/header.png}\\2021 ICPC Taiwan Online Programming Contest}
...
%\tableofcontents
%\vspace*{8mm}
\problem{A}{Olympic Ranking}{1}{1024}
\problem{B}{Aliquot Sum}{10}{1024}
\problem{C}{A Sorting Problem}{3}{1024}
\problem{D}{Drunk Passenger}{2}{1024}
\problem{E}{Eatcoin}{5}{1024}
\problem{F}{Flip}{3}{1024}
\problem{G}{Garden Park}{3}{1024}
\problem{H}{A Hard Problem}{3}{1024}
\problem{I}{ICPC Kingdom}{3}{1024}
\problem{J}{JavaScript}{2}{1024}
\end{document}
